...
It shows that the students in '2024A' were stronger overall in their pre-work compared to the other cohorts. 
...
There were 8 students scored 80 and above.
No, nothing surprised me because looking at the full dataset, all students in the table are from Arabic countries. So it’s not that high scorers are uniquely from those countries the entire dataset is.
...
I chose Lina Barakat.
She submitted all three projects, and none of them were late or missing. Her grades are also very high (98, 95, and 96).
This tells me she is a serious and consistent student. She does her work on time and performs really well. She seems organized and strong academically -- just like me.